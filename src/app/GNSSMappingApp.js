...
"        <button id='btnExportHtml' class='btn-purple'>📄 HTML保存</button>",
                    ...
                    "    (function() {",
                    "        const zoneNames = {",
                    "            1: '第1系 長崎県、鹿児島県など', 2: '第2系 福岡県、熊本県など', 3: '第3系 山口県、島根県など',",
                    "            4: '第4系 香川県、愛媛県など', 5: '第5系 兵庫県、鳥取県など', 6: '第6系 京都府、大阪府など',",
                    "            7: '第7系 石川県、富山県など', 8: '第8系 新潟県、長野県など', 9: '第9系 東京都、千葉県など',",
                    "            10: '第10系 青森県、秋田県など', 11: '第11系 北海道西部', 12: '第12系 北海道中央部',",
                    "            13: '第13系 北海道東部', 14: '第14系 小笠原諸島など', 15: '第15系 沖縄本島など',",
                    "            16: '第16系 先島諸島など', 17: '第17系 大東諸島など', 18: '第18系 沖ノ鳥島', 19: '第19系 南鳥島'",
                    "        };",
                    "        let autoZoneIndex = 0;",
                    "        let p0 = {lat: 35, lng: 139};",
                    "        let minLat = Infinity, minLng = Infinity;",
                    ...
                    "        } else if (lat >= 41.3) {",
                    "            if (lng < 141) autoZoneIndex = 11; else if (lng < 143) autoZoneIndex = 12; else autoZoneIndex = 13;",
                    "        } else if (lat >= 39) { autoZoneIndex = 10; }",
                    "        else if (lng >= 139.5) { autoZoneIndex = 9; }",
                    "        else if (lng >= 137.8) { autoZoneIndex = 8; }",
                    "        else if (lng >= 136.5) { autoZoneIndex = 7; }",
                    "        else if (lng >= 134.8) { autoZoneIndex = 6; }",
                    "        else if (lng >= 133.5) { autoZoneIndex = (lat < 34.5) ? 4 : 5; }",
                    "        else if (lng >= 131.5) { autoZoneIndex = (lat < 34.5) ? 4 : 3; }",
                    "        else if (lng >= 130.2) { autoZoneIndex = 2; }",
                    "        else { autoZoneIndex = 1; }",
                    "        const autoOption = document.querySelector('#dxfZone option[value=\"auto\"]');",
                    "        if (autoOption && autoZoneIndex > 0) {",
                    "            autoOption.textContent = '平面直角座標 (' + zoneNames[autoZoneIndex] + ')';",
                    "        }",
                    "    })();",
