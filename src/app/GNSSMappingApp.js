...
"        <button id='btnExportHtml' class='btn-purple'>📄 HTML保存</button>",
                    ...
                    "        let p0 = {lat: 35, lng: 139};",
                    "        if (exportData.points && exportData.points.length > 0) p0 = exportData.points[0];",
                    "        else if (exportData.customLines && exportData.customLines.length > 0) p0 = {lat: exportData.customLines[0].latlngs[0][0], lng: exportData.customLines[0].latlngs[0][1]};",
                    "        else if (exportData.areas && exportData.areas.length > 0) p0 = {lat: exportData.areas[0].coords[0][0], lng: exportData.areas[0].coords[0][1]};",
                    ...
                    "        if (exportData.areas) { exportData.areas.forEach((area, i) => {",
                    ...
                    "            }); }",
                    "        }); }",
                    "        if (exportData.edges) { exportData.edges.forEach(edge => {",
                    "            const p1 = exportData.points.find(p => p.id === edge.from);",
                    "            const p2 = exportData.points.find(p => p.id === edge.to);",
                    "            if (p1 && p2) {",
                    ...
                    "            }",
                    "        }); }",
                    "        if (exportData.customLines) { exportData.customLines.forEach(line => {",
                    ...
                    "        if (exportData.points) { exportData.points.forEach(p => {",
                    ...
                    "        }); }",
                    "        if (exportData.customTexts) { exportData.customTexts.forEach(t => {",
