...
export class GNSSMappingApp {
            ...
            setMode(mode) {
                ...
                if (mode === APP_CONFIG.MODES.SELECT) {
                    ...
                    this.els.modeInstructions.innerHTML = "🔗 <b>測線モード</b>: ポイントを順にクリックして結線します。";
                } else if (mode === APP_CONFIG.MODES.DRAW_LINE) {
                    this.els.modeInstructions.innerHTML = "〰️ <b>自由線モード</b>: 地図上をクリックして連続線を引きます。";
            ...
            addPoint(lat, lng, name = null) {
                ...
                const newPoint = { id, name: name || `${this.pointIdCounter - 1}`, lat, lng };
